...
public class SwitchOnTransitToDelivered extends AsyncTask<Void, Integer, Integer> {
    ...
    public SwitchOnTransitToDelivered(Context context,String order_id){
        this.context = context;
        this.order_id = order_id;
        this.API = "http://lastmilesale.com/api/change-order-status";
    ...
    protected Integer doInBackground(Void... params) {
        SwitchOnTransitToDeliveredRequest addProductToCartRequest = new SwitchOnTransitToDeliveredRequest(API,order_id,listener);
...
class SwitchOnTransitToDeliveredRequest extends StringRequest{
    private Map<String, String> params;

    public SwitchOnTransitToDeliveredRequest(String API,String order_id, Response.Listener<String> listener){
